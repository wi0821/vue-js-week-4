export default {
    props:["isFieldError","temp", "editProduct", "addProduct", "createImages"],
            ...
            <div class="row">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control"
                        v-model.Lazy="temp.imageUrl" placeholder="請輸入圖片連結">
                    </div>
                ...
                <div class="mb-2" v-if="temp.imagesUrl">
                    <template v-for="(image,index) in temp.imagesUrl" :key="index">
                        <div class="mb-3">
                            <input type="text" v-model="temp.imagesUrl[index]" class="form-control" placeholder="請輸入圖片連結">
